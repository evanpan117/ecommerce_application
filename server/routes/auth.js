...
Router.post('/signup', async (req, res) => {
  try {
    ...
    console.log('receivedFields',receivedFields,req.body)

    const result = await pool.query(
      'select count(*) as count from admin_user where email=$1',
      [email]
    );
    ...
    await pool.query(
      'insert into admin_user(first_name, last_name, email, password) values($1,$2,$3,$4)',
